  ...
  return (
    <header className="sticky top-0 z-40 border-b border-studio-border bg-studio-bg/90 backdrop-blur">
      <div className="mx-auto flex min-h-16 max-w-[1480px] items-center justify-between gap-3 px-3 py-2 sm:px-6">
        <NavLink to="/" aria-label="Screen Recorder home" className="flex min-w-0 items-center gap-3 text-studio-text">
        ...
        <nav aria-label="Primary navigation" className="flex shrink-0 items-center gap-1 overflow-x-auto">
          {links.map((link) => {
